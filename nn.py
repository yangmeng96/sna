...
def nn_load(datatype, disease_mapping, X_train, X_test, code_type):
    ...
    try:
        ...
        print("Neural Network feature data loaded")
    except:
        print("Neural Network feature data not found, training Neural Network now...")
        train_features, test_features = nn_train(datatype, disease_mapping, file_paths, X_train, X_test)
